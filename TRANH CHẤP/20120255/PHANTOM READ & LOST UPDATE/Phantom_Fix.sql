...
insert into HOPDONG 
values(@iD,@mST,@ngDaiDien,@sLChiNhanh,@soTaiKhoan,@nganHang,@ngBD,@ngKT,0,@doiTac)
...
create
--alter
proc usp_Liet_Ke_HD_Chua_Duyet_FIX
...
begin try
	...
	if not exists (select* from HOPDONG where DOITAC = @iD_DoiTac and TINHTRANG = 0)
	begin
